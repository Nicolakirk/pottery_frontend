...
const productQuantity = cart.getProductQuantity(product.product_id)
 ...
 <Card.Title>  <h4>{product.title}</h4> </Card.Title>
    ...
    <Form as={Row}>
        ...
        <Col sm="6">
            <Button sm="6"  variant="outline-dark" onClick={()=>cart.addOneToCart(product.product_id)} className="mx-2">+</Button>
            <Button sm="6" variant="outline-dark" onClick={()=>cart.removeOneFromCart(product.product_id)}className="mx-2">-</Button>
        </Col>
    </Form>
...
:
<Button variant ="dark" onClick={()=> cart.addOneToCart(product.product_id)}> Add To Cart</Button>
}
</Card.Body>
       </Card>
       </Col>
